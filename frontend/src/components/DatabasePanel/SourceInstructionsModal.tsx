...
import './SourceInstructionsModal.css';

interface SourceInstructionsModalProps {
  value: string;
  folderName: string;
...
export default function SourceInstructionsModal({
  value,
  folderName,
  onSave,
  onClose,
}: SourceInstructionsModalProps) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h2>Source Instructions: {folderName}</h2>
        ...
        <div className="modal-info-banner">
          ...
          <span>
            Tell the agent how to interpret files from this folder. These instructions help the agent understand
        ...
        <div className="modal-content">
          ...
          <textarea
            className="source-instructions-textarea"
            value={editedValue}
            onChange={(e) => setEditedValue(e.target.value)}
            onKeyDown={handleKeyDown}
            placeholder="e.g., 'These are API documentation files. Treat code examples as reference material.' or 'Personal notes and research findings.'"
            autoFocus
          />
        </div>
