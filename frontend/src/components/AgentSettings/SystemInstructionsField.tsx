  ...
  return (
    <div className="system-instructions-field">
      <div className="field-label">
        System instructions
        <span className="help-icon" title="The system prompt that defines the agent's behavior">
      ...
      <button className="system-instructions-preview" onClick={onClick}>
        ...
        <div className="edit-hint">
          <span className="edit-hint-text">User can change system instructions from this text field, which has a popup</span>
        </div>
      </button>
    </div>
  );
